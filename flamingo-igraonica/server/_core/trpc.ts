...
export const flamingoAdminProcedure = t.procedure.use(t.middleware(async opts => {
  if (!opts.ctx.adminSession) throw new TRPCError({ code: "UNAUTHORIZED", message: "Flamingo admin session required" });
